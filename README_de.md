...
6. [Ansible Rolle konfigurieren](#ansible-rolle-konfigurieren)
...
7. [Funktionalitäten](#funktionalitäten)
   - [Nginx Reverse Proxy](#nginx-reverse-proxy)
   - [SSL-Zertifikat Management](#ssl-zertifikat-management)
   - [Mailcow Konfiguration](#mailcow-konfiguration)
   - [Security Features](#security-features)
8. [Verzeichnisstruktur](#verzeichnisstruktur)
9. [Wichtige Pfade auf dem Server](#wichtige-pfade-auf-dem-server)
